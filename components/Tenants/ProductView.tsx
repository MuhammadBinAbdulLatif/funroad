    ...
    <div className='px-4 lg:px-12 py-10'>
        <div className='border rounded-md bg-white overflow-hidden'>
            <div className='relative aspect-[3.9] border-b'>
                <Image src={ data.cover?.url|| data?.image?.url || '/auth-background.png'} alt={data.name} fill className='object-cover' />
            </div>
                    ...
                    <div className='border-y flex'>
                        ...
                        <div className='px-6 py-4 flex items-center justify-center lg:border-r '>
                            ...
                            {data.tenant.image?.url && ( 
                                <Image src={data.tenant.image.url} alt={data.tenant.name}  className='rounded-full border shrink-0 size-[20px]' width={20} height={20} />
                            )}
